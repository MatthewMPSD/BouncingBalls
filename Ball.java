...
public class Ball implements Collider
{
    ...
    public static Vector2 checkBallCollisionContinuous (Ball b1, Ball b2, Vector2 v)
    {
        ...
        double aActual = b2.position.x - b1.position.x;
        double bActual = b2.position.y - b1.position.y;
        double aTarget = (targetDist * aActual) / dist;
        double bTarget = (targetDist * bActual) / dist;
        ...
        {
            System.out.println(current + " " + collisionVector + " " + next + " Between Ys");
